...
export default {
    ...
    data() {
        return{
            wordList: [],
            wordListDay :[
                {title: '资本', num: 200, themeColor: 'green'},
                {title: '原初爱', num: 302, themeColor: 'pink'},
                {title: '压榨', num: 113, themeColor: 'yellow'},
                {title: '好看', num: 222, themeColor: 'green'},
                {title: 'youtube', num: 23, themeColor: 'pink'}, 
                {title: '国外', num: 113, themeColor: 'yellow'},
             ...
             wordListWeek :[
                {title: '55', num: 200, themeColor: 'green'},
                {title: '44', num: 302, themeColor: 'pink'},
                {title: '55', num: 302, themeColor: 'pink'},
                {title: '5', num: 113, themeColor: 'yellow'},
                {title: '22', num: 222, themeColor: 'green'},
            ...
            wordListMonth :[
                {title: '22', num: 302, themeColor: 'pink'},
                {title: '55', num: 113, themeColor: 'yellow'},                
                {title: '22', num: 23, themeColor: 'pink'},
                {title: '55', num: 113, themeColor: 'yellow'},
                {title: '22', num: 222, themeColor: 'green'},
                {title: '5', num: 23, themeColor: 'pink'}, 
            ...
            wordListYear :[
                {title: '1', num: 113, themeColor: 'yellow'},
                {title: '2', num: 222, themeColor: 'green'},
                {title: '1', num: 23, themeColor: 'pink'},             
                {title: '1', num: 23, themeColor: 'yellow'},             
                {title: '1', num: 23, themeColor: 'pink'},             
                {title: '1', num: 23, themeColor: 'green'},             
                {title: '15', num: 23, themeColor: 'pink'}, 
